@push('styles')
	<link href="{{ asset('css/masters/hs_ng_reasons.css') }}" rel="stylesheet">
@endpush

@section('title')
Heat Sink N.G. Reasons Master
@endsection
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <div class="row mb-3">
                    <div class="col-4">
                        <form action="/masters/heat-sink-ng-reasons/save-reason" method="post" id="frm_reasons">
                            @csrf
...
@push('scripts')
	<script src="{{ asset('js/masters/hs_ng_reasons.js') }}" defer></script>
@endpush
