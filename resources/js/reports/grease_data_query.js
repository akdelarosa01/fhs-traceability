...
(function() {
    const GreaseDataQuery = function() {
        return new GreaseDataQuery.init();
    }
    GreaseDataQuery.init = function() {
        $D.init.call(this);
    ...
    GreaseDataQuery.init.prototype = $.extend(GreaseDataQuery.prototype, $D.init.prototype);
    GreaseDataQuery.init.prototype = GreaseDataQuery.prototype;

    $(document).ready(function() {
        var _GreaseDataQuery = GreaseDataQuery();
        _GreaseDataQuery.permission();
        _GreaseDataQuery.drawDatatables();

        $('.dataTables_scrollBody').on('scroll', function() {
            _GreaseDataQuery.$tbl_data_search.fixedHeader.adjust();
        });
        ...
        $('#btn_search').on('click', function() {
            ...
            if (search_type !== "" && search_value == "") {
                _GreaseDataQuery.swMsg("Please Provide a the type of data to search","warning");
            } else {
                _GreaseDataQuery.$tbl_data_search.ajax.reload(false);
            }
            
        });

        $('#btn_export').on('click', function() {
            var link = '/reports/grease-data-query/download-excel?_token='+ _GreaseDataQuery.token;
